...
class ModelOperation(object):
        ...
        for epoch in range(args.train_epochs):
            for batch in train_data_loader:
                ...
                if global_step % args.logging_steps == 0:
                    ...
                    # print("global step {}, epoch: {}/{}, loss: {}".format(global_step,global_step,args.train_epochs,loss))
                    tic_train = time.time()
                loss.backward()
                self.optimizer.step()
                ...
                if self.cur_process_rank == 0 and global_step % args.logging_steps == 0 and (rloss>loss or global_step % args.save_steps==0):
                    rloss=loss
                    if args.do_eval:
                    ...
                    output_dir = \
                        os.path.join(args.output_dir, "model_{}_{}".format(epoch,global_step))
    ...
    def evaluation(self, args):
        ...
        # print("loss:{} - ppl:{} - {}s/step".format(avg_loss, ppl, avg_speed))
        self.model.train()
